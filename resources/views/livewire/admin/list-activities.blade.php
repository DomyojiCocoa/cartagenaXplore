<div class="w-full">
    ...
    <div class="p-8">
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <div class="flex items-center">
                ...
                <div class="pl-14">
                    <button class="border border-slate-600 text-gray-500 px-4 py-2 rounded-xl mr-2">Eliminar actividad</button>
                ...
                <tbody>
                    ...
                    <tr class="border-b hover:bg-gray-50">
                        <td class="p-4 flex items-center">
                            <input type="checkbox" class="mr-2">Titulo de  actividad
                        </td>
                        <td class="py-4 px-6">10-12-2024</td>
                        <td class="p-4 flex items-center">

                            <span class="text-green-500 border border-green-500 font-semibold px-2 py-1 rounded-lg">Activo</span>

                            <span class="text-red-500 border border-red-500 font-semibold px-2 py-1 rounded-lg">Eliminado</span>
    ...
    <x-dialog-modal wire:model="createActivityModalVisible">
        ...
        <x-slot name="footer">
            <button wire:click="closeCreateActivityModal" class="bg-gray-500 text-white px-4 py-2 rounded-lg">Cancelar</button>
    ...
    <x-dialog-modal wire:model="deleteActivityModalVisible">
        ...
        <x-slot name="footer">
            <button wire:click="closeDeleteActivityModal" class="bg-gray-500 text-white px-4 py-2 rounded-lg">Cancelar</button>
            <button wire:click="confirmDeleteActivity" class="bg-red-500 text-white px-4 py-2 rounded-lg">Eliminar</button>
        </x-slot>
    </x-dialog-modal>
</div>
