<div class="w-full">
    ...
    <div class="p-8">
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <div class="flex items-center">
                <div class="pl-14">
                    <button class="bg-orange-500 text-white px-4 py-2 rounded-xl ">Añadir eventos</button>

                </div>
                <div class="pl-14">
                    <button class="border border-slate-600 text-gray-500 px-4 py-2 rounded-xl mr-2">Eliminar eventos</button>
        ...
        <div class="bg-white shadow rounded-lg overflow-hidden w-full ">
            <table class="min-w-full w-full">
                ...
                <thead class="bg-slate-900 text-white">
                    <tr>
                        <th class="p-4 text-left">Eventos</th>
                ...
                <tbody>
                    ...
                    <tr class="border-b hover:bg-gray-50">
                        <td class="p-4 flex items-center">
                            <input type="checkbox" class="mr-2">Titulo del evento
                        </td>
