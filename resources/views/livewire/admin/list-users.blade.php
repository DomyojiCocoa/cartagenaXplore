<div class="w-full">
    ...
    <div class="p-8">
        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <div class="flex items-center">
                <div class="pl-14">
                    <button class="bg-orange-500 text-white px-4 py-2 rounded-xl ">Añadir usuario</button>

                </div>
                <div class="pl-14">
                    <button class="border border-slate-600 text-gray-500 px-4 py-2 rounded-xl mr-2">Eliminar usuarios</button>
