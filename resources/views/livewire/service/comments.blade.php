    ...
    <div class="mt-5 p-5 border-b border-gray-300 pb-4">
        <div class="flex items-center mb-4">
            ...
            <div>
                ...
                <p class="text-lg text-orange-500">{{ $comment->user->created_at }}</p>
        </div>
...
@endforeach
    ...
    <div class="flex justify-center mt-10">
        <button
            class="border text-xl border-orange-500 text-orange-500 py-2 px-20 rounded-3xl hover:bg-orange-500 hover:text-white shadow-md">Ver
            más opciones</button>
    </div>
</div>
