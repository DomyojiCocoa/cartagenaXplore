<div class="flex flex-col lg:flex-row justify-center items-center pt-6 bg-white min-h-screen lg:px-18 px-10">
    <div class="flex flex-col lg:flex-row w-full pt-16 lg:px-10 space-y-8 lg:space-y-0 lg:space-x-8">

        <div class=" rounded-xl mt-10 lg:w-1/4 p-8 h-ful  bg-slate-100">
            ...
            <ul>
                <li class="mb-8">
                    ...
                    <ul class="ml-4 lg:ml-6 mt-4">
                        <li class="mb-4 cursor-pointer hover:bg-gray-200 p-3 rounded-xl text-lg lg:text-xl">
