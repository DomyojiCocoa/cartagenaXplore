<div class="relative w-full">
    ...
    <div class="overflow-x-auto whitespace-nowrap flex space-x-4">
        @foreach($forecasts as $forecast)
            ...
            <div class="inline-block w-1/3 md:w-1/5 lg:w-1/6 bg-gradient-to-b from-blue-400 to-blue-200 shadow-md rounded-lg p-6 text-center">
                <div class="flex justify-center mb-4">
                    <img src="https://openweathermap.org/img/wn/{{ $forecast['icon'] }}@2x.png" alt="{{ $forecast['description'] }}" class="w-16 h-16 md:w-24 md:h-24 lg:w-32 lg:h-32">
                </div>
