<div class="pt-10">
    <h1 class="text-3xl md:text-4xl lg:text-6xl font-semibold mb-7">Sitios para explorar</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 grid-rows-5 gap-4">
        ...
        <div class="md:col-span-2 md:row-span-2 md:col-start-4 md:row-start-4 p-4">
            <h2 class="text-lg md:text-xl lg:text-2xl font-bold">CASTILLO DE SAN FELIPE</h2>
            ...
            <div class="pt-4 flex justify-center">
                <div class="w-48 md:w-60 h-10 text-sm border border-orange-500 text-orange-500 hover:bg-orange-500 hover:text-white rounded-3xl text-center shadow-md flex items-center justify-center">
